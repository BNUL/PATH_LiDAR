...
class LiDARWaveformSimulator:
    ...
    def _calculate_gap_probability(self) -> float:
        ...
        print(f"Calculated gap probability (Fs0): {Fs0:.3f}")
        print(f"  Distribution model: {model_name}")
        print(f"  Crown density: {density:.4f} trees/m²")
        print(f"  Crown radius: {radius:.2f} m")
        print(f"  Crown coverage: {crown_coverage:.3f}")
    ...
    def _calculate_gap_probability_from_real_trees(self) -> float:
        ...
        print(f"Calculated gap probability (Fs0): {Fs0:.3f}")
        print(f"  Distribution model: {model_name}")
        print(f"  Footprint radius: {self.config.footprint_radius:.2f} m")
        print(f"  Footprint area: {footprint_area:.2f} m²")
        print(f"  Total crown area: {total_crown_area:.2f} m²")
        print(f"  Crown coverage ratio: {crown_coverage:.3f}")
